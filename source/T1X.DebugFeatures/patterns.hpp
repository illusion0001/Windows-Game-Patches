namespace Patterns
{
	...
	// Dev Menu
	// TODO: Mask these!
	const wchar_t* AllocMemoryforStructure = L"48 83 ec 38 45 33 c9 4c 8d 05 62 80 b7 00 4c 89 44 24 20 41 8d 51 10 e8 cc 3b 60 fe 48 83 c4 38 c3";
	const wchar_t* CreateDevMenuStructure = L"40 53 48 83 ec 20 48 8b 81 b0 00 00 00 48 8b da 48 85 c0 74 22 66 66 66 0f 1f 84 00 00 00 00 00 48 8b d0 48 8b 40 40 48 85 c0 75 f4 48 85 d2 74 06 48 89 5a 40 eb 07 48 89 99 b0 00 00 00 48 8b d3 48 c7 43 40 00 00 00 00 48 89 4b 38 e8 1e dd ff ff 48 8b c3 48 83 c4 20 5b c3";
	const wchar_t* AllocDevMenuMemoryforStructure = L"48 89 5c 24 10 48 89 6c 24 18 48 89 74 24 20 57 48 83 ec 30 48 85 c9 bf 01 00 00 00 41 8b f1 49 8b e8 48 0f 45 f9 48 8b da e8 d2 01 00 00 84 c0 0f 85 14 70 d5 00 e8 65 5e 04 00 48 85 c0"; // L"48 89 5c 24 10 48 89 6c 24 18 48 89 74 24 20 57 48 83 ec 30 48 85 c9 bf 01 00 00 00 41 8b f1 49 8b e8 48 0f 45 f9 48 8b da e8 d2 01 00 00 84 c0 0f 85 14 70 d5 00 e8 65 5e 04 00 48 85 c0 74 47 83 b8 e0 03 00 00 00 74 3e e8 3e 00 00 00 48 8b 08 4c 8b 51 38 48 8b 4c 24 60 48 89 4c 24 28 48 8b c8 48 8b d7 89 74 24 20 4c 8b c3 4c 8b cd 41 ff d2 48 8b 5c 24 48 48 8b 6c 24 50 48 8b 74 24 58 48 83 c4 30 5f c3 33 c0 eb e7 40 53 48 83 ec 20 48 8b 81 b0 00 00 00 48 8b da 48 85 c0 74 22 66 66 66 0f 1f 84 00 00 00 00 00 48 8b d0 48 8b 40 40 48 85 c0 75 f4 48 85 d2 74 06 48 89 5a 40 eb 07 48 89 99 b0 00 00 00 48 8b d3 48 c7 43 40 00 00 00 00 48 89 4b 38 e8 1e dd ff ff 48 8b c3 48 83 c4 20 5b c3";
	const wchar_t* AllocDevMenu1 = L"4c 8b d9 0f b6 d2 49 b9 01 01 01 01 01 01 01 01 4c 0f af ca 49 83 f8 10";
	const wchar_t* DevMenuCreateHeader = L"48 89 5c 24 08 57 48 83 ec 20 41 8b d8 48 8b f9 e8 7b dc ff ff 48 8d 05 b4 4b 53 02 89 9f b8 00 00 00 48 8b 5c 24 30 48 89 07 33 c0 48 89 87 a0 00 00 00 89 87 a8 00 00 00 48 89 87 b0 00 00 00 88 87 bc 00 00 00 48 89 87 c0 00 00 00 48 89 87 c8 00 00 00 48 89 87 d0 00 00 00 89 87 d8 00 00 00 48 8b c7 c6 87 ac 00 00 00 01 48 83 c4 20 5f c3";
	const wchar_t* DevMenuCreateEntry = L"48 89 5c 24 08 48 89 74 24 10 57 48 83 ec 20 49 8b d9 49 8b f0 48 8b f9 e8 03 de ff ff 48 8b 44 24 50 33 c9 48 89 47 60 48 8b 44 24 58 48 89 87 80 00 00 00 48 8d 05 dd 4d 53 02 48 89 07 48 8b c7 48 89 8f a4 00 00 00 48 89 9f b0 00 00 00 48 89 b7 b8 00 00 00 c7 87 a0 00 00 00 01 00 00 00 48 89 8f c0 00 00 00 48 85 f6 74 0a ff 86 d8 00 00 00 48 89 7e 38 48 8b 5c 24 30 48 8b 74 24 38 48 83 c4 20 5f c3";
	const wchar_t* DevMenuAddBool = L"48 89 5c 24 08 48 89 74 24 10 57 48 83 ec 20 49 8b d9 49 8b f8 48 8b f1 e8 23 fb ff ff 33 c9 48 89 9e 80 00 00 00 48 8b 5c 24 30 48 8d 05 06 73 53 02 48 89 06 48 8d 05 24 4f 01 00 48 89 86 b0 00 00 00 48 89 8e a0 00 00 00 48 89 4e 60 c7 86 a8 00 00 00 03 00 00 00 0f b6 07 88 86 b8 00 00 00 48 8b c6 48 89 7e 60 48 89 4e 58 c7 86 a0 00 00 00 01 00 00 00 48 8b 74 24 38 48 83 c4 20 5f c3";
	// Melee test
	// 167 bytes
	const wchar_t* MeleeMenuHook = L"e8 4a bb 1f ff 41 bf e0 00 00 00 4c 89 6c 24 20 41 8b cf 45 33 c9 4d 8b c5 48 8b d3 e8 7e 09 1a ff 4c 8b f0 48 85 c0 74 24 45 8b c7 33 d2 48 8b c8 e8 29 e5 d2 ff 45 33 c0 48 8d 15 f3 80 9d 01 49 8b ce e8 87 b1 1e ff 4c 8b f0 eb 03 4c 8b f7 49 8b ce e8 a3 8d 8a 00 45 33 c9 4c 89 6c 24 20 4d 8b c5 48 8b d3 49 8b cc e8 31 09 1a ff 4c 8b f8 48 85 c0 74 2e 4d 8b c4 33 d2 48 8b c8 e8 dc e4 d2 ff 45 33 c9 48 89 7c 24 28 4d 8b c6 48 89 7c 24 20 48 8d 15 55 66 a1 01 49 8b cf e8 9d af 1e ff eb 03 48 8b c7";
	// Give Player Weapons
