...
static void ApplyPatches()
{
    ...
    if (bEnableDevMenu)
    {
        ...
        const uintptr_t DebugCameraKeyCheckAddr = FindAndPrintPatternW(L"48 8b 08 41 8d 50 2c ff 15 ? ? ? ?", L"DebugCameraKeyCheck", 7) ? : FindAndPrintPatternW(L"41 8d 50 2c 48 8b 08 ff 15 ? ? ? ?", L"DebugCameraKeyCheck_v130", 7);
